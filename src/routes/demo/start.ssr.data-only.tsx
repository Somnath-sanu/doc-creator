...
export const Route = createFileRoute("/demo/start/ssr/data-only")({
  ...
  loader: async () => {
    console.log("server start delay");
    await new Promise((res) => setTimeout(res, 10000));
    console.log("server delay over");
    return await getPunkSongs();
  },
  pendingComponent: () => {
    return (
      <p className="flex items-center justify-center text-3xl text-black bg-neutral-300 h-screen w-screen">
        Loading...
      </p>
    );
  },
